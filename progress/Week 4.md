...
```
## 3. Results
On the Amsterdam side we made a video and got it to stabilize in the middle. From the Lisbon side our wheel is already stabilising with ease starting from the bottom but we still have to work on maintaining the position in the middle.

## 4. Reflection 
For Amsterdam: Making the wheel go from start to middle. Lisbon: Make it stabilize in the middle, by changing PID Controls. Also working to make the graphs and take the data for the pwm-angle with the influence of the PID algorithm.
